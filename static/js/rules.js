...
function execute_test (string, player) {
  if (string === 'is_straight_flush') {
    return is_straight_flush(player);
  }
  if (string === 'is_four_of_a_kind') {
    return is_four_of_a_kind(player);
  }
  if (string === 'is_full_house') {
    return is_full_house(player);
  }
  if (string === 'is_flush') {
    return is_flush(player);
  }
  if (string === 'is_straight') {
    return is_straight(player);
  }
  if (string === 'is_three_of_a_kind') {
    return is_three_of_a_kind(player);
  }
  if (string === 'is_two_pair') {
    return is_two_pair(player);
  }
  if (string === 'is_one_pair') {
    return is_one_pair(player);
  }
  if (string === 'is_hi_card') {
    return is_hi_card(player);
  }
